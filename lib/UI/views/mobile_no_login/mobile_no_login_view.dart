...
class MobileNoLoginView extends StatefulWidget {
  @override
  _MobileNoLoginViewState createState() => _MobileNoLoginViewState();
}

class _MobileNoLoginViewState extends State<MobileNoLoginView> {
  bool isEnabled = true;
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MobileNoLoginViewModel>.reactive(
      ...
      viewModelBuilder: () => MobileNoLoginViewModel(),
    );
  }
}
